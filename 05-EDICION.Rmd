...
Si se desea añadir un signo de puntuación en la presentación crítica, es necesario agregar una etiqueta <span class="emph-code"> \<ee\/\></span> al interior del elemento <span class="emph-code"> \<tok\></span> y se escribe en el atributo ```nform``` el signo deseado.
